...
class WordPressTest extends TestCase
{
     ...
     * @test
     */
    public function should_call_cf7helper_functions()
    {
     ...
     * @test
     */
    public function should_insert_hook_when_activated()
    {
     ...
     * @test
     */
    public function should_delete_hook_when_deactivated()
    {
     ...
     * @test
     */
    public function should_select_when_called()
    {
     ...
     * @test
     */
    public function should_select_hook_with_right_parameters()
    {
        $hook = $this->utility->getHistoryByFuncName('selectHook');
        $entry = current($hook);
     ...
     * @test
     */
    public function should_select_target_with_right_parameters()
    {
        $target = $this->utility->getHistoryByFuncName('selectTarget');
     ...
     * @test
     */
    public function should_select_input_with_right_parameters()
    {
        $input = $this->utility->getHistoryByFuncName('selectInput');
        $entry = current($input);
        $params = $entry->getParams()[2];
     ...
     * @test
     */
    public function should_add_button_when_activated()
    {
     ...
     * @test
     */
    public function should_load_scripts_when_activated()
    {
     ...
     * @test
     */
    public function should_add_activate_hook_when_activated()
    {
     ...
     * @test
     */
    public function should_add_deactivate_hook_when_activated()
    {
