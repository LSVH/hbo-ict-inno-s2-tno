...
class WordPressPostTypesTest extends TestCase
{
    ...
    /** @test */
    public function uses_id_of_current_model_if_attribute_is_missing_and_same_type()
    {
    ...
    /** @test */
    public function inserts_model_and_its_relations()
    {
    ...
    /** @test */
    public function inserts_model_and_its_relations_and_then_deletes_it_and_its_relations()
    {
        $this->utility->clearMeta();
        $models = $this->insertModelWith2Relations();
