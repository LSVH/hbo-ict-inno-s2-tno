...
class ListFormTest extends TestCase
{
    ...
    /** @test */
    public function renders_nothing_found_message_without_any_displayable_items()
    {
        $subject = new ListForm($this->integration, $this->model, [
    ...
    /** @test */
    public function renders_actions_only_with_displayable_values()
    {
        $subject = new ListForm($this->integration, $this->model, [
    ...
    /** @test */
    public function renders_add_new_button_with_displayable_values()
    {
        $subject = new ListForm($this->integration, $this->model, [
            new ItemDisplayable('hello', 'world'),
        ]);
    ...
    /** @test */
    public function renders_add_new_button_with_nothing_found_message()
    {
        $subject = new ListForm($this->integration, $this->model, []);
