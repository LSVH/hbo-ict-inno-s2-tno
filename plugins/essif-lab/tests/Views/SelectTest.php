...
{
    /** @test */
    public function renders_nothing_without_items()
    {
    ...
    /** @test */
    public function renders_nothing_when_all_items_have_non_displayable_values()
    {
        $subject = new Select($this->integration, $this->model, [
    ...
    /** @test */
    public function renders_only_the_items_which_are_displayable()
    {
        $subject = new Select($this->integration, $this->model, [
    ...
    /** @test */
    public function renders_value_as_label_when_no_label_set()
    {
        $subject = new Select($this->integration, $this->model, [
    ...
    /** @test */
    public function renders_select_name_correctly()
    {
        $subject = new Select($this->integration, $this->model, [
            new ItemDisplayable('hello'),
        ]);
