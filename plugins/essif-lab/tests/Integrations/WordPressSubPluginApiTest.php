...
class WordPressSubPluginApiTest extends TestCase
{
     ...
     */
    public function adds_insert_action(string $subject, callable $instanceOf)
    {
     ...
     * @param callable $instanceOf
     */
    public function adds_delete_action(string $subject, callable $instanceOf)
    {
     ...
     * @param callable $instanceOf
     */
    public function adds_select_filter(string $subject, callable $instanceOf)
    {
