...
<<<<<<< HEAD
	...
	private function generateListItems(Model $from, Model $to): array
	{
		return array_map(function (Model $model) {
			...
			$titleLabel = array_key_exists(Constants::TYPE_INSTANCE_TITLE_ATTR,
				$attr) ? $attr[Constants::TYPE_INSTANCE_TITLE_ATTR] : '-';
			$title = new Displayable($ID, $titleLabel);

			$descriptionLabel = array_key_exists(Constants::TYPE_INSTANCE_DESCRIPTION_ATTR,
				$attr) ? $attr[Constants::TYPE_INSTANCE_DESCRIPTION_ATTR] : '-';
...
=======
    ...
    private function generateListItems(Model $from, Model $to): array
    {
        return array_map(function (Model $model) {
            ...
            $titleLabel = array_key_exists(
                Constants::TYPE_INSTANCE_TITLE_ATTR,
                $attr
            ) ? $attr[Constants::TYPE_INSTANCE_TITLE_ATTR] : '-';
            $title = new Displayable($ID, $titleLabel);

            $descriptionLabel = array_key_exists(
                Constants::TYPE_INSTANCE_DESCRIPTION_ATTR,
                $attr
            ) ? $attr[Constants::TYPE_INSTANCE_DESCRIPTION_ATTR] : '-';
            $description = new Displayable($ID, $descriptionLabel);
